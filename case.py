...
class Case:
    ...
    def est_pleine(self):
        """
        Retourne si la case est pleine (differente deespace).

        Returns:
            bool: True si la case est pleine, False autrement.
        """
        return self.contenu.upper() != " "
    ...
    def est_pion(self, pion):
        ...
        assert pion.upper() in [" ", "O", "X"], "Case: pion doit être ' ', 'O' ou 'X'."

        return self.contenu == pion.upper()